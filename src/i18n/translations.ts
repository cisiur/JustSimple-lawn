...
const en = {
  ...
  'home.soilMoisture':      '🌱 Soil moisture: {{pct}}%',
  ...
  'reason.soilWet':                 'Soil is sufficiently moist — no watering needed.',
  'reason.soilDry':                 'Soil moisture is low — time to water.',
  'reason.soilUncertain':           'Soil moisture is within normal range — use your judgement.',
  'reason.forecastRainProbability': 'Rain is likely today or tomorrow — skip watering.',
  'reason.soilOversaturated':       'Soil has been saturated for several days — skip watering.',
  'reason.urgentDry':               'Soil has been completely dry for multiple days — water urgently.',
...
const pl: Translations = {
  ...
  'home.soilMoisture':      '🌱 Wilgotność gleby: {{pct}}%',
  ...
  'reason.soilWet':                 'Gleba jest wystarczająco wilgotna — podlewanie nie jest potrzebne.',
  'reason.soilDry':                 'Wilgotność gleby jest niska — czas podlać.',
  'reason.soilUncertain':           'Wilgotność gleby jest w normie — oceń sam.',
  'reason.forecastRainProbability': 'Deszcz jest prawdopodobny dziś lub jutro — pomiń podlewanie.',
  'reason.soilOversaturated':       'Gleba jest nasycona od kilku dni — pomiń podlewanie.',
  'reason.urgentDry':               'Gleba jest całkowicie sucha od kilku dni — podlej pilnie.',
...
const de: Translations = {
  ...
  'home.soilMoisture':      '🌱 Bodenfeuchte: {{pct}}%',
  ...
  'reason.soilWet':                 'Boden ist ausreichend feucht — kein Gießen nötig.',
  'reason.soilDry':                 'Bodenfeuchte ist niedrig — Zeit zum Gießen.',
  'reason.soilUncertain':           'Bodenfeuchte im Normalbereich — nach eigenem Ermessen entscheiden.',
  'reason.forecastRainProbability': 'Regen heute oder morgen wahrscheinlich — Gießen überspringen.',
  'reason.soilOversaturated':       'Boden ist seit mehreren Tagen gesättigt — Gießen überspringen.',
  'reason.urgentDry':               'Boden ist seit mehreren Tagen völlig trocken — dringend gießen.',
...
const es: Translations = {
  ...
  'home.soilMoisture':      '🌱 Humedad del suelo: {{pct}}%',
  ...
  'reason.soilWet':                 'El suelo tiene suficiente humedad — no hace falta regar.',
  'reason.soilDry':                 'La humedad del suelo es baja — es hora de regar.',
  'reason.soilUncertain':           'La humedad del suelo está en rango normal — decide según tu criterio.',
  'reason.forecastRainProbability': 'Es probable que llueva hoy o mañana — omite el riego.',
  'reason.soilOversaturated':       'El suelo lleva varios días saturado — omite el riego.',
  'reason.urgentDry':               'El suelo lleva varios días completamente seco — riega urgentemente.',
...
const fr: Translations = {
  ...
  'home.soilMoisture':      '🌱 Humidité du sol : {{pct}}%',
  ...
  'reason.soilWet':                 "Le sol est suffisamment humide — pas besoin d'arroser.",
  'reason.soilDry':                 "L'humidité du sol est faible — il est temps d'arroser.",
  'reason.soilUncertain':           "L'humidité du sol est normale — jugez selon votre expérience.",
  'reason.forecastRainProbability': "De la pluie est probable aujourd'hui ou demain — évitez d'arroser.",
  'reason.soilOversaturated':       'Le sol est saturé depuis plusieurs jours — évitez d\'arroser.',
  'reason.urgentDry':               "Le sol est complètement sec depuis plusieurs jours — arrosez d'urgence.",
...
const it: Translations = {
  ...
  'home.soilMoisture':      '🌱 Umidità del suolo: {{pct}}%',
  ...
  'reason.soilWet':                 'Il suolo è sufficientemente umido — irrigazione non necessaria.',
  'reason.soilDry':                 "L'umidità del suolo è bassa — è ora di irrigare.",
  'reason.soilUncertain':           "L'umidità del suolo è nella norma — valuta tu stesso.",
  'reason.forecastRainProbability': 'Pioggia probabile oggi o domani — salta l\'irrigazione.',
  'reason.soilOversaturated':       'Il suolo è saturo da diversi giorni — salta l\'irrigazione.',
  'reason.urgentDry':               'Il suolo è completamente secco da giorni — irrigare urgentemente.',
